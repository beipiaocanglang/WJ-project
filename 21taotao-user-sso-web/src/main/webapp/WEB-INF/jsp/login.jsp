...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="w">
            <div id="logo">
                <a href="http://wj.manager.server.com" clstag="passport|keycount|login|01">
        ...
        <form id="formlogin" method="post" onsubmit="return false;">
            <div class=" w1" id="entry">
                <div class="mc " id="bgDiv">
                    <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;"></div>
                    <div class="form ">
                ...
                <div class="free-regist">
                    <span>
                        ...
                        <a href="/user/showRegister" clstag="passport|keycount|login|08">免费注册&gt;&gt;</a>
                    </span>
                </div>
            </div>
        </form>
                ...
                doLogin:function() {
                    $.post("/user/login", $("#formlogin").serialize(),function(data){
                        if (data.status == 200) {
                            alert("登录成功！");
                            if (redirectUrl == "") {
                                location.href = "http://wj.portal.client.com";
                            } else {
