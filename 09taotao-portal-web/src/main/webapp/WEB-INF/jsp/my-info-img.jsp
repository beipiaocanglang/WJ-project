                        ...
                        <div id="content" class="c-3-5">
                            <div class="mod-main">
                                <div class="mt">
                                    <ul class="extra-l">
                                        <li class="fore-1">
                                            <a href="http://i.jd.com/user/info">基本信息</a>
                                        </li>
                                        <li class="fore-2">
                                            <a class="curr" href="http://i.jd.com/user/userinfo/showImg.html">头像照片</a>
                                        </li>
                                        <li class="fore-3">
                                ...
                                <div class="mc update-face-cont">
                                    <div class="update-lcol">
                                        ...
                                        <div class="smc face-list">
                                            <ul class="imgUl">
                                                <li value="1">
                                                    <img src="/images/defaultImgs/1.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                                <li value="2">
                                                    <img src="/images/defaultImgs/2.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                                <li value="3">
                                                    <img src="/images/defaultImgs/3.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                                <li value="4">
                                                    <img src="/images/defaultImgs/4.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                                <li value="5">
                                                    <img src="/images/defaultImgs/5.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                                <li value="6">
                                                    <img src="/images/defaultImgs/6.jpg" alt="" width="50" height="50">
                                                    <b></b>
                                                </li>
                                            </ul>
                                            <div class="btns mt20">
