...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <div class="w w1 header clearfix">
        <div id="logo">
            <a href="/">
                <img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回淘淘商城首页" alt="返回淘淘商城首页">
            </a>
        </div>
        <div class="language">
                ...
                <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
                    <div class="cart-dibu ui-ceilinglamp-current" style="width: 988px; height: 49px;">
                        <div class="control fdibu fdibucurrent">
                            ...
                            <span class="shopping">
                                <b></b>
                                <a href="http://wj.portal.client.com" target="_blank" clstag="clickcart|keycount|xincart|coudanlink" id="continue">继续购物</a>
                            </span>
                        </div>
