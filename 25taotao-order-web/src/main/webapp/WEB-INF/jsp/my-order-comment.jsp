        ...
        <div id="main">
                    ...
                    <div class="mod-main mod-comm extra-main" id="evalu01">
                        <div class="mt">
                            ...
                            <div class="extra-l ftx03 ml10">
                                <span id="tip-num">(<span class="num-comment">1</span>个待评价)</span>
                            </div>
                        </div>
                        <div class="mc">
                                                ...
                                                <div class="form" tagflag="true" isconspros="0" pid="975788">
                                                    ...
                                                    <div class="item tagEl" style="">
                                                        ...
                                                        <div class="fl">
                                                            <ul class="tips-list">
                                                                <li vid="132">
                                                                    <s class="f-check"></s>复印速度快
                                                                </li>
                                                                <li vid="128">
                                                                    <s class="f-check"></s>复印也不错
                                                                </li>
                                                                <li vid="131">
                                                                    <s class="f-check"></s>耗材便宜
                                                                </li>
                                                                <li vid="135">
                                                                    <s class="f-check"></s>使用方便
                                                                </li>
                                                                <li vid="136">
                                                                    <s class="f-check"></s>扫描方便
                                                                </li>
                                                                <li vid="134">
                                                                    <s class="f-check"></s>效果不错
                                                                </li>
                                                                <li vid="133">
                                                                    <s class="f-check"></s>功能齐全
                                                                </li>
                                                                <li vid="129">
                                                                    <s class="f-check"></s>机器不错
                                                                </li>
                                                                <li vid="137">
                                                                    <s class="f-check"></s>墨盒便宜
                                                                </li>
                                                                <li class="list-last">
                                                                    <div class="fore1">
            ...
            <div id="left" class="g-3-5 c-0">
                ...
                <div id="menu">
                    ...
                    <dl class="fore3">
                        <dt><a target="_blank" clstag="homepage|keycount|home2013|hbdsh" id="_MYJD_locallife" href="http://life.jd.com/localOrder/iniOrder.do">我的本地生活</a></dt></dl>
                    <dl class="fore4">
                        <dt>
                    ...
                    <dl class="fore5">
                        <dt>
                            <a target="_blank" clstag="homepage|keycount|home2013|htg" id="_MYJD_tuan" href="http://tuan.jd.com/order/index.php">我的团购</a></dt></dl>
                    <dl class="fore6">
                        <dt>
                            <a target="_blank" clstag="homepage|keycount|home2013|hjg" id="_MYJD_protection" href="http://jiabao.jd.com/protecting">价格保护</a></dt></dl>
                    <dl class="fore7">
                        <dt class="hc">
                            <b></b>
